...
export const Header = () => {
  return (
    ...
    <div className="flex justify-center items-center py-3 bg-black text-white text-sm gap-3">
      <p className="text-white/60 hidden md:block">Welcome to NIRVANA-HEALTHCHAIN</p>
  ...
  ></div>
   <Image src={Logo} alt="Saas app" height={45} width={45} className=" relative rounded-lg    "/>
    ...
    <nav className="hidden md:flex gap-6 text-black/60 items-center">
      ...
      <a href="#">Updates</a>
      <a href="#">Help</a>
      <button className="bg-black text-white px-4 py-2 rounded-lg font-medium inline-flex align-items justify-center tracking-tighter">Sign In</button>
    </nav>
    </div>
    </div>
    </div>
